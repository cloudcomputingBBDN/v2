...
def add_act():
	if not request.json or not 'actId' in request.json or not 'username' or not 'timestamp' in request.json or not 'caption' in request.json or not 'base64' in request.json or not 'category' in request.json: 
		abort(400)
	d=[]
